...
export default function TopBar() {
    return (
        <div className="sticky top-0 z-30 w-full flex justify-end items-center gap-3 px-4 py-3 md:px-8 md:py-4 bg-white/70 dark:bg-gray-900/70 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800/50 animate-in slide-in-from-top-4 fade-in duration-700">
            <QuickActions />
            <NotificationCenter />
            <MusicButton />
            <ThemeToggleButton />
